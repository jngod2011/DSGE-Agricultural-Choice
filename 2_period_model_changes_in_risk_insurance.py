...
ax.plot(grid, np.array(policy_z), label='policy_z')
ax.legend()
ax.set_xlabel(' pi_θ grid. q = f(theta, beta)')
ax.set_title('Optimal Choices Given Changes in pi_θ')
plt.show()
#fig.savefig('C:/Users/rodri/OneDrive/Documentos/IDEA/Phd tesi/figures/2period_optimality_changes_in_theta_insurance.png')


fig.savefig('C:/Users/rodri/OneDrive/Documentos/IDEA/Phd tesi/figures/2period_optimality_changes_in_theta_insurance_qfixed.png')
...
ax.plot(grid, np.array(policy_z), label='policy_z')
ax.legend()
ax.set_xlabel(' pi_ε grid')
ax.set_title('Optimal Choices Given Changes in pi_ε')
plt.show()
fig.savefig('C:/Users/rodri/OneDrive/Documentos/IDEA/Phd tesi/figures/2period_optimality_changes_in_epsilon_insurance.png')
